...
from lightrag.api.routers.template_routes import router as template_router
from lightrag.api.routers.entity_query_routes import router as entity_query_router
